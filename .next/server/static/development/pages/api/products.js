...
async function connectDb() {
  ...
  const db = await mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.connect("mongodb+srv://ehzeta:!Esanena4747@test-hiegz.mongodb.net/test?retryWrites=true&w=majority", {
    useCreateIndex: true,
